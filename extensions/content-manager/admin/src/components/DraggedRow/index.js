...
import { TableRow } from '../CustomTable/styledComponents'
import Close from './Close';

/* eslint-disable */
const DraggedRow = forwardRef(
  (
    {
      children,
      count,
...
DraggedRow.defaultProps = {
  ...
  onRemove: () => { },
  selectedItem: '',
  shouldToggleDraggedRowOverState: false,
  style: {},
  withLongerHeight: false,
};

DraggedRow.propTypes = {
...
DraggedRow.displayName = 'DraggedRow';

export default DraggedRow;
