...
const { createDefaultMetadatas, syncMetadatas } = require('strapi-plugin-content-manager/services/utils/configuration/metadatas');
const { createDefaultLayouts, syncLayouts } = require('strapi-plugin-content-manager/services/utils/configuration/layouts');
